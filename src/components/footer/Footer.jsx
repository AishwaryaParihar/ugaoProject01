  ...
  return (
    ...
    <div className="container ">
        <div className="flex flex-wrap  ">
            <div className="md:w-1/2 pr-4 pl-4  flex items-center px-4">
                <div className="join">
                    ...
                    <div className="gap-4">
                    <button className="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-green-500 text-white hover:green-600 border border-green-500 border-2 uppercase px-3 me-4">Learn more</button>
                    <button className=" inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline border border-green-500 border-2 uppercase btn-join px-2">refer a friend</button>
                    </div>
                </div>
            </div>
    ...
    {/* why ugaao */}
    <div className="container mx-auto sm:px-4 aboutugaoo py-5">
    ...
    {/* marquee  */}
      <div className="marquee">
        <div className="track flex justify-content-evenly py-3">
      ...
      <div className="footer container mx-auto sm:px-4 max-w-full mx-auto sm:px-4 border-t">
        {/* footer-content  */}
        <div className=" flex flex-wrap  flex flex-wrap container-footer">
        ...
        <hr />
        <div className="flex flex-wrap  container-footer">
          <div className="md:w-1/2 pr-4 pl-4 order-2 md:order-1">
            {" "}
            &#169; 2024, Ugaoo, All rights reserved
          </div>
          <div className="md:w-1/2 pr-4 pl-4 order-1 md:order-2">
            <div className="footer__payment ">
              <span className="visually-hidden">Payment methods</span>
              <ul
                className="list list-payment footer-col-ul flex justify-end gap-2  text-end"
                role="list"
              >
